...
public class FragranceAdapter extends RecyclerView.Adapter<FragranceAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(FragranceAdapter.ViewHolder holder, int position) {
        ...
        @SuppressLint("Range") String mName = dataCursor.getString(dataCursor.getColumnIndex(FragranceContract.FragranceEntry.COLUMN_NAME));
        @SuppressLint("Range") String mDescription = dataCursor.getString(dataCursor.getColumnIndex(FragranceContract.FragranceEntry.COLUMN_DESCRIPTION));
        @SuppressLint("Range") String mImageUrl = dataCursor.getString(dataCursor.getColumnIndex(FragranceContract.FragranceEntry.COLUMN_IMAGE));
        @SuppressLint("Range") int mPrice = dataCursor.getInt(dataCursor.getColumnIndex(FragranceContract.FragranceEntry.COLUMN_PRICE));
        @SuppressLint("Range") int mUserrating = dataCursor.getInt(dataCursor.getColumnIndex(FragranceContract.FragranceEntry.COLUMN_USERRATING));
